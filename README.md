...
The curriculum focuses on DOM tree generation and interaction, and covers procedural programming, object-oriented programming, Jasmine testing framework, backend development, and asynchronous patterns (XML, fetch, async functions, await, etc.), all following industry-level coding standards throughout.
